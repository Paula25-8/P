...
(function ($) {
    ...
    var plugin = {
        ...
        _render: function (el) {
            ...
            if (supportsCanvas) {
                ...
                if ((lineLabels.length > 0) && (legendId != ""))
                {
                    ...
                    // Estamos introduciendo la leyenda en archivo HTML
        ...
        _drawMarker: function (el, ctx, scale, color, textClass, width, data, reverseMarkers) {
            ...
            var style = (textClass != "" ? "class='" + textClass + "' " : "") + "style='" + (textClass == "" ? "font-size:8pt;font-family:Verdana,Arial,Helvetica,Sans Serif;text-decoration:none;" : "") + "width:120px;" + (pos != "" ? pos : "") + ";position:absolute;top:" + (y + el.position().top - (topOffset > 0 ? topOffset : 0)) + "px;left:" + (x + el.position().left) + "px;z-index:3000;'";
            if (data.link != "")
